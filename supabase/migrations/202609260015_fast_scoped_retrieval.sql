-- Keep scoped retrieval available even when the external embedding provider is slow
-- or unavailable. A null query embedding skips the semantic leg and still executes
-- permission-filtered full-text retrieval.
