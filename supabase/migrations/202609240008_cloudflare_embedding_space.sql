-- Zero-cost privacy-preserving embedding space for Cloudflare Workers AI BGE-M3.
-- BGE-M3 produces 1024-dimensional vectors. On an existing installation, re-embed all chunks
-- when changing embedding models. This migration is intended before production indexing begins.
